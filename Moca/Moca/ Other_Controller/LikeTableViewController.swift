...
//        let likeJsonModel.delegate = self // jsonModel에서 일 시키고, 그걸 self(여기서 쓸거임)
//        likeJsonModel.downloadItems() // jsonModel에서 이 메소드 실행해서 일 처리해!
//
//        // Custom Cell 정의
...
//
//
//        let addressNo = Int(cell.likeBrand!)
//        let likeDeleteModel = LikeDeleteModel() // instance 선언
//        _ = likeDeleteModel.likeDeleteItems(addressNo: addressNo!)
...
//        print(indexPath001!.row)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        likeJsonModel.downloadItems() // jsonModel의 downloadItems를 처리하게 할거야.
    }
