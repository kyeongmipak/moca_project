...
//  main
//
//  Created by Ria Song on 2021/03/03.
//

import Foundation

class BoardDeleteModel: NSObject{
    
    var urlPath = "http://127.0.0.1:8080/moca/jsp/board_delete.jsp"
    
    // insertItems의 () 매개변수들은 AddViewController에서 값을 넣어줘서 함께 실행할거고 → Bool로 실행 여부 확인할거야.
    func deleteItems(boardNo: String) -> Bool {
        var result: Bool = true
        let urlAdd = "?boardNo=\(boardNo)"
