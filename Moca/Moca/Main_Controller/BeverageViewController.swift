...
class BeverageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, CategoryRankJsonModelProtocol {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "BeverageTableViewCell") as! BeverageTableViewCell
...
//            let data = try! Data(contentsOf: url!)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sgBeverageDetail" {
