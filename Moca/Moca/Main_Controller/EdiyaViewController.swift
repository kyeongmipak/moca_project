...
class EdiyaViewController: UIViewController, UITableViewDelegate, BrandRankJsonModelProtocol, UITableViewDataSource, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EdiyaTableViewCell") as! EdiyaTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sgEdiyaDetail" {
