...
class ShakeViewController: UIViewController, UITableViewDelegate, CategoryRankJsonModelProtocol, UISearchBarDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ShakeTableViewCell") as! ShakeTableViewCell
...
//            let data = try! Data(contentsOf: url!)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sgShakeDetail" {
