...
class TwosomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, BrandRankJsonModelProtocol, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TwosomeTableViewCell") as! TwosomeTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sgTwosomeDetail" {
