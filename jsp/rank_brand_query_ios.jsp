...
<%
 ...
 try {
        ...
        String query2 = " from brand b, have h, menu m LEFT OUTER JOIN review r on r.menu_menuNo = m.menuNo where h.brand_brandNo = b.brandNo and h.menu_menuNo = m.menuNo and b.brandName = ? group by m.menuNo, h.brand_brandNo order by reviewAvg desc";
