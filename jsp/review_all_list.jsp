...
<%
    ...
    String B = "from review r, userinfo u where u.userEmail = r.userinfo_userEmail order by r.reviewInsertDate desc";
    //String A = "select r.reviewNo, r.menu_menuNo, u.userNickname, r.reviewContent, r.reviewImg, r.reviewStar, r.reviewInsertDate ";
    //String B = "from review r, userinfo u where u.userEmail = r.userinfo_userEmail and r.menu_menuNo = 3 order by r.reviewInsertDate desc";
    int count = 0;
